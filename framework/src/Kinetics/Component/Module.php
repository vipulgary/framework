...
use ThoughtYards\Kinetics\Component;
...
class Module extends Component
{
	...
	public function setControllerPath($value)
	{
		...
		throw new ThoughtException(Gateway::log("The controller '.$value.' is not a valid directory."));
	}
	...
	public function setViewPath($path)
	{
		...
		throw new ThoughtException(Gateway::log("The view path  '.$path.' is not a valid directory."));			
	}
	...
	public function setLayoutPath($path)
	{
		...
		throw new ThoughtException(Gateway::log("The layout path  '.$path.' is not a valid directory."));
	}
