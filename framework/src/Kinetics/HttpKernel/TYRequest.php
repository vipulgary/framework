...
class TYRequest extends TYComponent
{
	...
	public $csrfTokenName='GATEWAY_CSRF_TOKEN';
	public $csrfCookie;
	...
	public function getScriptUrl()
	{
		if($this->_scriptUrl===null)
		{
			...
			throw new ThoughtException('CHttpRequest is unable to determine the entry script URL.');
		}
	...
	public function getPathInfo()
	{
		if($this->_pathInfo===null)
		{
			...
			throw new ThougtException('CHttpRequest is unable to determine the path info of the request.');
	...
	public function validateCsrfToken($event)
	{
		...
		$this->getIsDeleteRequest())
		{
			...
			$valid = false;
			if (!$valid)
			throw new ThoughtException('The CSRF token could not be verified.');
		}
	}
}
